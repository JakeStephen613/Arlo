...
EXERCISE_SYSTEM = """Create exactly 3 conceptual Feynman-style teaching questions.
Test deep understanding, not memorization. Help students explain in their own words.
Return JSON: {"questions": ["question1", "question2", "question3"]}"""

ASSESSMENT_SYSTEM = """Assess this student's conceptual explanation.
Return JSON: {"mastery_score": int 0-100, "what_went_well": ["..."], "gaps_in_understanding": ["..."]}
Be precise and fair. Identify specific gaps with brief corrections. Stay encouraging."""
